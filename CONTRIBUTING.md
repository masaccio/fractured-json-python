...
Use [Ruff](https://github.com/astral-sh/ruff) to make sure the code follows the style. The repository includes a `settings.json` for [Visual Studio Code](https://code.visualstudio.com) to enforce this.

## Test your code modification

Testing and configuration is based on [UV](https://github.com/astral-sh/uv) and is used for all package management and testing. See the UV pages for how to install UV.

You should also verify that existing [tests](./tests) are still working and you are encouraged to add new ones. You are also encouraged to add tests that at least maintain the current level of code coverage. You can run the tests using the following commands from the root folder assuming you have installed [UV](https://github.com/astral-sh/uv):
